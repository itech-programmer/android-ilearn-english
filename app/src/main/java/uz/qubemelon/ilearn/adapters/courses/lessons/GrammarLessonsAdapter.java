...
public class GrammarLessonsAdapter extends RecyclerView.Adapter<GrammarLessonsAdapter.LessonViewHolder>{

    /* all global field instances */
    private Activity activity;
    private List<LessonList> lessons_lists;

    public GrammarLessonsAdapter(Activity activity, List<LessonList> lessons_lists) {
    ...
    public class LessonViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            Intent intent = new Intent(activity, GrammarLessonActivity.class);
