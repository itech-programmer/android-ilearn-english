...
public class VocabularyQuestionsAnswersAdapter extends RecyclerView.Adapter<VocabularyQuestionsAnswersAdapter.QuestionAnswersHolder> {
    ...
    private FragmentVocabularyQuestions fragment_questions;
    private TextView text_user_point;
    private ImageView right_wrong;
    private boolean isAnswered = false;

    /* this is the constructor for the leaderboard */
    public VocabularyQuestionsAnswersAdapter(FragmentVocabularyQuestions fragment_questions, List<Answers> answers_item_list, Activity activity, String question_id, int point, ImageView right_wrong, TextView text_user_point) {
                ...
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        if (!isSuccess) {
                            ...
                            VocabularyQuestionsActivity.isPlayed.put(answer_id, true);
                            // try {
