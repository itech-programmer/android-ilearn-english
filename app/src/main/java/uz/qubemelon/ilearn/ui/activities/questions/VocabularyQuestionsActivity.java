...
public class VocabularyQuestionsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question_storage = new Storage(VocabularyQuestionsActivity.this);
    ...
    private void get_question_list(int LESSON_ID) {
        ...
        question_call.enqueue(new Callback<String>() {
            ...
            public void onResponse(@NonNull Call<String> call, @NonNull Response<String> response) {
                ...
                ErrorHandler.get_instance().handle_error(response.code(), VocabularyQuestionsActivity.this, dialog);
                if (response.isSuccessful()) {
                        ...
                        if (isSuccess) {
                            ...
                            if (question_list != null) {
                                if (question_list.getQuestionList().size() != 0) {
                                    ...
                                    final Dialog overview_dialog = new Dialog(VocabularyQuestionsActivity.this);
                                    ...
                                    let_start.setOnClickListener(view -> {
                                        ...
                                        FragmentVocabularyQuestions question_fragment = new FragmentVocabularyQuestions();
                                    ...
                                    overview_dialog.setOnDismissListener(dialogInterface -> {
                                        if (!isStarted) {
                                            Intent intent = new Intent(VocabularyQuestionsActivity.this, VocabularyLessonActivity.class);
                                    ...
                                    Toast.makeText(VocabularyQuestionsActivity.this, "NO Question Found!", Toast.LENGTH_SHORT).show();
                                }
                            }
                            ...
                            Toast.makeText(VocabularyQuestionsActivity.this, message, Toast.LENGTH_SHORT).show();
                    ...
                    Utility.dismiss_dialog(dialog);
                    Toast.makeText(VocabularyQuestionsActivity.this, R.string.no_data_found, Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(@NonNull Call<String> call, @NonNull Throwable throwable) {
                ...
                if (throwable instanceof IOException) {
                    Toast.makeText(VocabularyQuestionsActivity.this, R.string.connection_timeout, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
