...
public class LessonActivity extends AppCompatActivity implements Html.ImageGetter {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (LESSON_ID != 0) {
            ...
            if (Utility.is_internet_available(LessonActivity.this)) {
    ...
    private void get_lesson(int LESSON_ID) {
        ...
        lesson_call.enqueue(new Callback<String>() {
            ...
            public void onResponse(@NonNull Call<String> call, @NonNull Response<String> response) {
                ...
                ErrorHandler.get_instance().handle_error(response.code(), LessonActivity.this, dialog);
                if (response.isSuccessful()) {
                            ...
                            if (lesson != null) {
                                ...
                                layout_exercises.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        ...
                                        LessonActivity.this.overridePendingTransition(R.anim.slide_left, R.anim.slide_right);
                                        finish();
                                ...
                                layout_question.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View view) {
                                        Intent intent = new Intent(LessonActivity.this, QuestionsActivity.class);
                                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                        intent.putExtra(Utility.LESSON, lesson.getTitle());
                                        startActivity(intent);
                                        LessonActivity.this.overridePendingTransition(R.anim.slide_left, R.anim.slide_right);
                                ...
                                Toast.makeText(LessonActivity.this, "NO Lesson Found!", Toast.LENGTH_SHORT).show();
                            }
                            /* dismiss the dialog */
                    ...
                    Utility.dismiss_dialog(dialog);
                    Toast.makeText(LessonActivity.this, R.string.no_data_found, Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(@NonNull Call<String> call, @NonNull Throwable throwable) {
                ...
                if (throwable instanceof IOException) {
                    Toast.makeText(LessonActivity.this, R.string.connection_timeout, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    public void onBackPressed() {
        Intent intent = new Intent(LessonActivity.this, VocabularyLessonsListActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(intent);
        finish();
    }
