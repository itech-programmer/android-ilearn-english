...
import uz.qubemelon.ilearn.adapters.courses.exercises.GrammarExercisesAdapter;
...
public class GrammarExerciseActivity extends AppCompatActivity {
    ...
    private GrammarExercisesAdapter grammar_exercises_adapter;
    private TextView text_point;

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_grammar_exercises);

        init_view();

        exercise_storage = new Storage(GrammarExerciseActivity.this);
    ...
    private void get_exercise_list(int LESSON_ID) {
        ...
        exercise_call.enqueue(new Callback<String>() {
            ...
            public void onResponse(@NonNull Call<String> call, @NonNull Response<String> response) {
                ...
                ErrorHandler.get_instance().handle_error(response.code(), GrammarExerciseActivity.this, dialog);
                if (response.isSuccessful()) {
                        ...
                        if (isSuccess) {
                            ...
                            if (exercise_list != null) {
                                if (exercise_list.getExerciseList().size() != 0) {
                                    ...
                                    final Dialog overview_dialog = new Dialog(GrammarExerciseActivity.this);
                                    ...
                                    let_start.setOnClickListener(view -> {
                                        ...
                                        grammar_exercises_adapter = new GrammarExercisesAdapter(GrammarExerciseActivity.this, exercise_list.getExerciseList());
                                        // Attach the adapter to the recyclerview to populate items
                                        exercise_recycler_view.setAdapter(grammar_exercises_adapter);
                                        // Set layout manager to position the items
                                        exercise_recycler_view.setLayoutManager(new LinearLayoutManager(GrammarExerciseActivity.this));
                                        // That's all!
                                    });
                                    ...
                                    overview_dialog.setOnDismissListener(dialogInterface -> {
                                        if (!isStarted) {
                                            Intent intent = new Intent(GrammarExerciseActivity.this, GrammarLessonActivity.class);
                                    ...
                                    Toast.makeText(GrammarExerciseActivity.this, "NO Question Found!", Toast.LENGTH_SHORT).show();
                                }
                            }
                            ...
                            Toast.makeText(GrammarExerciseActivity.this, message, Toast.LENGTH_SHORT).show();
                    ...
                    Utility.dismiss_dialog(dialog);
                    Toast.makeText(GrammarExerciseActivity.this, R.string.no_data_found, Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(@NonNull Call<String> call, @NonNull Throwable throwable) {
                ...
                if (throwable instanceof IOException) {
                    Toast.makeText(GrammarExerciseActivity.this, R.string.connection_timeout, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    public void onBackPressed() {
        Intent intent = new Intent(this, GrammarLessonActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(intent);
        finish();
    }
