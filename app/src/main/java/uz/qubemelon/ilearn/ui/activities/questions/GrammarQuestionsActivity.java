...
import uz.qubemelon.ilearn.ui.fragments.questions.FragmentVocabularyQuestions;
import uz.qubemelon.ilearn.utilities.Utility;

public class GrammarQuestionsActivity extends AppCompatActivity {
    ...
    public APIResponse question_list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question_storage = new Storage(GrammarQuestionsActivity.this);
    ...
    private void get_question_list(int LESSON_ID) {
        ...
        question_call.enqueue(new Callback<String>() {
            ...
            public void onResponse(@NonNull Call<String> call, @NonNull Response<String> response) {
                ...
                ErrorHandler.get_instance().handle_error(response.code(), GrammarQuestionsActivity.this, dialog);
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        if (isSuccess) {
                            ...
                            Gson gson = new Gson();
                            question_list = gson.fromJson(response.body(), APIResponse.class);

                            if (question_list != null) {
                                if (question_list.getQuestionList().size() != 0) {

                                    /* show overview dialog first */
                                    final Dialog overview_dialog = new Dialog(GrammarQuestionsActivity.this);
                                    ...
                                    let_start.setOnClickListener(view -> {
                                        ...
                                        FragmentGrammarQuestions question_fragment = new FragmentGrammarQuestions();
                                    ...
                                    overview_dialog.setOnDismissListener(dialogInterface -> {
                                        if (!isStarted) {
                                            Intent intent = new Intent(GrammarQuestionsActivity.this, GrammarLessonActivity.class);
                                    ...
                                    Toast.makeText(GrammarQuestionsActivity.this, "NO Question Found!", Toast.LENGTH_SHORT).show();
                                }
                            }
                            ...
                            Toast.makeText(GrammarQuestionsActivity.this, message, Toast.LENGTH_SHORT).show();
                    ...
                    Utility.dismiss_dialog(dialog);
                    Toast.makeText(GrammarQuestionsActivity.this, R.string.no_data_found, Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(@NonNull Call<String> call, @NonNull Throwable throwable) {
                ...
                if (throwable instanceof IOException) {
                    Toast.makeText(GrammarQuestionsActivity.this, R.string.connection_timeout, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
