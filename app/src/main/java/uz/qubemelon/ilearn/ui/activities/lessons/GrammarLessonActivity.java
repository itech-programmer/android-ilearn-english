...
import uz.qubemelon.ilearn.ui.activities.exercises.GrammarExerciseActivity;
...
public class GrammarLessonActivity extends AppCompatActivity implements Html.ImageGetter {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (LESSON_ID != 0) {
            ...
            if (Utility.is_internet_available(GrammarLessonActivity.this)) {
    ...
    private void get_lesson(int LESSON_ID) {
        ...
        lesson_call.enqueue(new Callback<String>() {
            ...
            public void onResponse(@NonNull Call<String> call, @NonNull Response<String> response) {
                ...
                ErrorHandler.get_instance().handle_error(response.code(), GrammarLessonActivity.this, dialog);
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        if (isSuccess) {
                            ...
                            if (lesson != null) {
                                ...
                                layout_exercises.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        Intent intent = new Intent(GrammarLessonActivity.this, GrammarExerciseActivity.class);
                                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                        intent.putExtra(Utility.LESSON, lesson.getTitle());
                                        startActivity(intent);
                                        GrammarLessonActivity.this.overridePendingTransition(R.anim.slide_left, R.anim.slide_right);
                                        finish();
                                ...
                                layout_question.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View view) {
                                        Intent intent = new Intent(GrammarLessonActivity.this, GrammarQuestionsActivity.class);
                                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                        intent.putExtra(Utility.LESSON, lesson.getTitle());
                                        startActivity(intent);
                                        GrammarLessonActivity.this.overridePendingTransition(R.anim.slide_left, R.anim.slide_right);
                                ...
                                Toast.makeText(GrammarLessonActivity.this, "NO Lesson Found!", Toast.LENGTH_SHORT).show();
                            }
                            /* dismiss the dialog */
                            ...
                            Toast.makeText(GrammarLessonActivity.this, message, Toast.LENGTH_SHORT).show();
                        }
                    ...
                    Utility.dismiss_dialog(dialog);
                    Toast.makeText(GrammarLessonActivity.this, R.string.no_data_found, Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(@NonNull Call<String> call, @NonNull Throwable throwable) {
                ...
                if (throwable instanceof IOException) {
                    Toast.makeText(GrammarLessonActivity.this, R.string.connection_timeout, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    public void onBackPressed() {
        Intent intent = new Intent(GrammarLessonActivity.this, GrammarLessonsListActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(intent);
        finish();
    }
